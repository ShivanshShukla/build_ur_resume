...
export default function Home() {
  return (
    <div className="bg-sand dark:bg-stone-950 text-text-main dark:text-stone-200 transition-colors duration-200 min-h-screen flex flex-col font-body">
      {/* HEADER */}
      <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-stone-200 dark:border-stone-800 bg-surface-light/90 backdrop-blur-md dark:bg-surface-dark/90 px-6 md:px-10 py-4 shadow-sm">
        ...
        <div className="flex flex-1 justify-end gap-6 items-center">
          ...
          <div className="flex items-center gap-4 border-l border-stone-200 dark:border-stone-700 pl-6">

            {/* Theme Toggle Component */}
            <ThemeToggle />

            <Link to="/login" className="text-text-main dark:text-stone-300 text-sm font-semibold hover:text-primary transition-colors hidden sm:block">
              Login
            </Link>
      ...
      <main className="w-full max-w-[1440px] mx-auto px-4 md:px-6 py-6 flex flex-col gap-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-7 bg-surface-light dark:bg-surface-dark rounded-3xl p-8 md:p-12 border border-stone-200 dark:border-stone-800 shadow-sm flex flex-col justify-center items-start relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-text-muted dark:text-stone-400 text-lg font-normal leading-relaxed max-w-md mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                ...
                <button className="flex items-center justify-center rounded-full h-12 px-8 bg-stone-100 dark:bg-stone-800 text-text-main dark:text-white text-sm font-bold hover:bg-stone-200 dark:hover:bg-stone-700 transition-colors">
                  View Templates
                </button>
              </div>
              <div className="flex items-center gap-4 pt-4 border-t border-stone-100 dark:border-stone-800 w-full">
                ...
                <p className="text-xs font-semibold text-text-muted dark:text-stone-400">Loved by professionals worldwide</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 bg-stone-100 dark:bg-stone-900 rounded-3xl overflow-hidden border border-stone-200 dark:border-stone-800 shadow-sm relative group min-h-[400px]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex items-end justify-center p-8">
              <div className="bg-white/95 backdrop-blur dark:bg-surface-dark/95 rounded-xl p-4 shadow-xl flex items-center gap-4 border border-stone-100 dark:border-stone-700 w-full max-w-xs animate-bounce">
        ...
        <div className="bg-surface-light dark:bg-surface-dark rounded-3xl p-6 md:p-8 border border-stone-200 dark:border-stone-800 shadow-sm">
          ...
          <div className="flex overflow-x-auto gap-4 pb-2 scrollbar-hide -mx-2 px-2 snap-x">
            <a className="flex-shrink-0 w-48 group snap-start" href="#">
              <div className="aspect-[3/4] rounded-xl overflow-hidden shadow-sm border border-stone-100 dark:border-stone-700 bg-stone-100 mb-3 relative">
              ...
              <h4 className="font-bold text-sm text-text-main dark:text-stone-200 font-display">The Modernist</h4>
            ...
            <a className="flex-shrink-0 w-48 group snap-start" href="#">
              ...
              <h4 className="font-bold text-sm text-text-main dark:text-stone-200 font-display">The Executive</h4>
            ...
            <a className="flex-shrink-0 w-48 group snap-start" href="#">
              ...
              <h4 className="font-bold text-sm text-text-main dark:text-stone-200 font-display">The Creative</h4>
            ...
            <a className="flex-shrink-0 w-48 group snap-start" href="#">
              ...
              <h4 className="font-bold text-sm text-text-main dark:text-stone-200 font-display">The Minimalist</h4>
              <p className="text-[10px] text-text-muted uppercase tracking-wide">General</p>
            </a>
            <a className="flex-shrink-0 w-48 group flex flex-col justify-center items-center h-auto rounded-xl border-2 border-dashed border-stone-200 dark:border-stone-700 hover:border-primary/50 hover:bg-primary/5 transition-all text-center p-4" href="#">
              <span className="material-symbols-outlined text-4xl text-text-muted group-hover:text-primary mb-2">add_circle</span>
              <span className="font-bold text-sm text-text-main dark:text-stone-300 group-hover:text-primary">See All Templates</span>
            </a>
          </div>
        </div>

        <div className="bg-surface-light dark:bg-surface-dark rounded-3xl p-8 border border-stone-200 dark:border-stone-800 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-text-muted dark:text-stone-500 text-xs font-bold tracking-[0.1em] uppercase font-display whitespace-nowrap">Trusted by pros at</p>
          <div className="flex flex-wrap justify-center md:justify-end gap-x-8 gap-y-4 opacity-60 grayscale hover:grayscale-0 transition-all duration-500 w-full">
            <span className="text-lg font-bold font-display text-stone-600 dark:text-stone-300 flex items-center gap-1.5"><span className="material-symbols-outlined text-primary text-xl">change_history</span> Acme</span>
            <span className="text-lg font-bold font-display text-stone-600 dark:text-stone-300 flex items-center gap-1.5"><span className="material-symbols-outlined text-secondary text-xl">hexagon</span> HexaGlobal</span>
            <span className="text-lg font-bold font-display text-stone-600 dark:text-stone-300 flex items-center gap-1.5"><span className="material-symbols-outlined text-primary text-xl">emergency</span> MedTech</span>
            <span className="text-lg font-bold font-display text-stone-600 dark:text-stone-300 flex items-center gap-1.5"><span className="material-symbols-outlined text-secondary text-xl">bolt</span> FastStream</span>
            <span className="text-lg font-bold font-display text-stone-600 dark:text-stone-300 flex items-center gap-1.5"><span className="material-symbols-outlined text-primary text-xl">cloud</span> CloudNine</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 bg-surface-light dark:bg-surface-dark rounded-3xl p-8 border border-stone-200 dark:border-stone-800 shadow-sm">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 h-full">
              <div className="p-5 rounded-2xl bg-stone-50 dark:bg-stone-900/50 hover:bg-white border border-stone-100 dark:border-stone-800 hover:border-primary/20 hover:shadow-md transition-all duration-300 group">
                ...
                <p className="text-xs text-text-muted dark:text-stone-400">See changes instantly as you type. No switching modes.</p>
              </div>
              <div className="p-5 rounded-2xl bg-stone-50 dark:bg-stone-900/50 hover:bg-white border border-stone-100 dark:border-stone-800 hover:border-stone-300 hover:shadow-md transition-all duration-300 group">
                ...
                <p className="text-xs text-text-muted dark:text-stone-400">Optimized for Applicant Tracking Systems.</p>
              </div>
              <div className="p-5 rounded-2xl bg-stone-50 dark:bg-stone-900/50 hover:bg-white border border-stone-100 dark:border-stone-800 hover:border-secondary/20 hover:shadow-md transition-all duration-300 group">
                ...
                <p className="text-xs text-text-muted dark:text-stone-400">Download as PDF or Word in seconds.</p>
              </div>
              <div className="p-5 rounded-2xl bg-stone-50 dark:bg-stone-900/50 hover:bg-white border border-stone-100 dark:border-stone-800 hover:border-amber-200 hover:shadow-md transition-all duration-300 group">
                ...
                <p className="text-xs text-text-muted dark:text-stone-400">Smart bullet points and skill suggestions.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-3xl border border-stone-200 dark:border-stone-800 shadow-sm flex flex-col gap-4">
            ...
            <p className="text-text-main dark:text-stone-300 text-sm leading-relaxed font-medium">"I was struggling to get callbacks until I used the Executive template. The formatting is clean, warm, and professional."</p>
            <div className="flex items-center gap-3 mt-auto pt-3 border-t border-stone-100 dark:border-stone-800">
          ...
          <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-3xl border border-stone-200 dark:border-stone-800 shadow-sm flex flex-col gap-4">
            ...
            <p className="text-text-main dark:text-stone-300 text-sm leading-relaxed font-medium">"The AI suggestions were a lifesaver. I didn't know how to phrase my achievements, but this tool made it easy."</p>
            <div className="flex items-center gap-3 mt-auto pt-3 border-t border-stone-100 dark:border-stone-800">
          ...
          <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-3xl border border-stone-200 dark:border-stone-800 shadow-sm flex flex-col gap-4">
            ...
            <p className="text-text-main dark:text-stone-300 text-sm leading-relaxed font-medium">"Simply the best resume builder out there. The live preview is fantastic and exporting to PDF is flawless."</p>
            <div className="flex items-center gap-3 mt-auto pt-3 border-t border-stone-100 dark:border-stone-800">
      ...
      {/* FOOTER */}
      <footer className="bg-white dark:bg-surface-dark border-t border-stone-200 dark:border-stone-800 pt-16 pb-8 px-6 md:px-10 mt-auto">
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row justify-between gap-12 md:gap-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10 md:gap-20">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a className="text-text-muted dark:text-stone-400 text-sm hover:text-primary transition-colors" href="#">Terms</a>
            </div>
          </div>
        </div>
        <div className="max-w-[1440px] mx-auto mt-16 border-t border-stone-100 dark:border-stone-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
